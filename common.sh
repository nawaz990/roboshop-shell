...
SYSTEMD_SETUP() {
  ...
  sed -i -e 's/MONGO_DNSNAME/dev-mongodb.devopsn69.online/' -e 's/REDIS_ENDPOINT/dev-redis.devopsn69.online/' -e 's/CATALOGUE_ENDPOINT/dev-catalogue.devopsn69.online/'  /home/roboshop/${COMPONENT}/systemd.service &>>$LOG
